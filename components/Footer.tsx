        ...
        <footer className="bg-gray-900 border-t-2 border-gray-800">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">A Guilda</h3>
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Regras</h3>
                        <ul className="mt-4 space-y-4">
                ...
                <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col items-center text-center">
                    <p className="font-cinzel text-xl text-glow-accent">Nerd Threads</p>

...
const SuccessIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-400 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
    </svg>
);

const WarningIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-yellow-400 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
...
const Notification: React.FC = () => {
  ...
  const baseStyle = "bg-gray-900 border-l-4 text-gray-200 font-bold p-4 rounded-lg shadow-lg flex items-center gap-4 max-w-md";
